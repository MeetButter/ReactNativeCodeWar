...
* Then, integrate Redux and any Redux Middleware (thunk or saga) into this App for handling the side effects of `like` actions with Redux, move away from current local state implementation since it is buggy and less performant. (This task is to verify your knowledge with Redux and its middleware)
